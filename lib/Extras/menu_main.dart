...
import 'main_page_extra.dart';

class MenuDemoState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        body: new ListView(padding: kMaterialListPadding, children: <Widget>[
          ...
          new PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
                    new PopupMenuItem<String>(
                        value: _simpleValue1, child: new Text(_simpleValue1)),
                    new PopupMenuItem<String>(
                        value: _simpleValue2, child: new Text(_simpleValue2)),
                    new PopupMenuItem<String>(
                        value: _simpleValue3, child: new Text(_simpleValue3))
                  ]),
